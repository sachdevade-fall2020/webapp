...
trait DatabaseRepositoryTrait
{
   ...
   */
     ...
     */
    public function get($id, array $related = null, $throw = true)
    {
     ...
     * @throws \App\Exceptions\ModelNotFoundException
     */
    public function getWhere($column, $value, array $moreWhere = null, $throw = true)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Collection
     */
    public function getWhereIn($column, $value, array $moreWhere = null, $throw = true)
    {
    ...
    public function throwNotFoundException()
    {
        throw new ModelNotFoundException(
            sprintf('No %s record found.', getClassName($this->model))
